...
function ShoesItems(props) {
	...
	return (
		...
		<div className={`${isActive ? 'card bg-dark text-white shadow-lg rounded row w-100 px-4 m-5  py-4' : 'shadow-lg rounded card bg-dark text-white row m-5  py-2'}`} style={{ maxWidth: "18rem" }} >
